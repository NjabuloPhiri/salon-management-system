...
<section class="bg-pink-100 py-12">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold mb-6 text-center text-pink-600">Book an Appointment</h1>
        ...
        <section class="py-12 bg-cover bg-center" style="background-image: url('https://img.freepik.com/premium-photo/various-brushes-cosmetics-purple-tint_23-2148181401.jpg');">
            <form action="{{ route('booking.store') }}" method="POST" id="booking-form" class="bg-white p-8 rounded-lg shadow-lg">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="appointment_time" class="block text-gray-700 font-medium mb-2">Available Time Slots:</label>
                    ...
                    <div>
                        ...
                        <input type="number" id="group_size" name="group_size" value="{{ old('group_size', 1) }}" min="1"
                            class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500">
                    </div>
