        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:justify-center gap-x-10">
                ...
                <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        <img src="images/hair-installation.jpg"
                            alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
                        <div class="px-4 py-3 w-72">
                            <span class="text-gray-400 mr-3 uppercase text-xs font-bold">Hair Installation</span>

                            <ul>
                                <li class="text-black-600 text-sm mb-2">Plain Installation</li>
                                <li class="text-black-600 text-sm mb-2">Installation + Style</li>
                                <li class="text-black-600 text-sm mb-2">Cornrows</li>
                ...
                <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        <img src="images/natural-hair-service.jpg"
                            alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
                        <div class="px-4 py-3 w-72">
                            <span class="text-gray-400 mr-3 uppercase text-xs font-bold">Natural Hair Services</span>

                            <ul>
                                <li class="text-black-600 text-sm mb-2">Hair Wash</li>
                                <li class="text-black-600 text-sm mb-2">Relax (Dark & Lovely)</li>
                                <li class="text-black-600 text-sm mb-2">Pony Tail</li>
                ...
                <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        <img src="images/manicure.jpg"
                            alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
                        <div class="px-4 py-3 w-72">
                            <span class="text-gray-400 mr-3 uppercase text-xs font-bold">Manicure</span>

                            <ul>
                                <li class="text-black-600 text-sm mb-2">Acrylic Overlay</li>
                                <li class="text-black-600 text-sm mb-2">Plain Soft Gel Tips</li>
                                <li class="text-black-600 text-sm mb-2">Full Manicure & Gel O/L</li>
