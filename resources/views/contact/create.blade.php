...
<div class="max-w-2xl mx-auto px-4 py-6 bg-white shadow-md rounded-lg">
    <h1 class="text-2xl font-bold text-gray-800 mb-4" style="font-family: 'Linden Hill', cursive;" data-aos="fade-up">
        Contact Us</h1>
    ...
    <form action="{{ route('contact.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            <button type="submit"
                class="bg-pink-500 text-white py-2 px-4 rounded-md shadow-sm hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50">Send
                Message</button>
        </div>
    </form>
</div>
